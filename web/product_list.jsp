							...
							<td>
										...
										<c:forEach items="${pb.products }" var="b" >
											<td>
												<div class="divbookpic">
													<p>
														<a href="product_info.jsp"><img src="${b.imgurl }" width="115"
								...
								<div class="pagination">
									<ul>
										...
										<li class="nextpage"><a href="${pageContext.request.contextPath}/pageServlet?currentPage=${pb.currentPage==pb.totalPage?pb.currentPage:pb.currentPage+1}&category=${pb.category}">下一页&gt;&gt;</a>
										</li>
